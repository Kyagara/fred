...
public class ModBlocks {
	...
	public static void registerModBlocks() {
		...
		if (Fred.CONFIG.enableReiFumoBlock()) {
			final Block REI_FUMO_BLOCK = new ReiFumoBlock(FabricBlockSettings.copy(Blocks.WHITE_WOOL));
			registerBlock("rei_fumo_block", REI_FUMO_BLOCK);
			Registry.register(Registries.ITEM_GROUP, ModItems.FRED_BLOCK_GROUP, FabricItemGroup.builder().icon(() -> new ItemStack(REI_FUMO_BLOCK)).displayName(Text.translatable("itemGroup.fred.blocks")).build());
		}
